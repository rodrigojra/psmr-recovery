 ...
 * 
 * This is a copy of bftsmart.tom.server.defaultservices.DefaultSingleRecoverable
 *
 */
public abstract class SequentialRecovery implements Recoverable, SingleExecutable {
    ...
    public SequentialRecovery() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SequentialRecovery.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
